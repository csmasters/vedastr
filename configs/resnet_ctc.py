...
character = '!"#$%&"'"()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]_`abcdefghijklmnopqrstuvwxyz{|}~¡¢£¤¥§©«­®°³"'·»¼½¾ÀÁÅÇÈÉÍÑÓ×ÚÜàáâãäçèéêìíîïñòóôöøúüýĄęİıłńœŞşǵəɪʃʊ˚ΛβμЙй฿–—‘’“”„†•…※⁶⁺⁻₁₂€₹℃™⅓⅔⅛ⅠⅡⅢⅣⅤⅥⅦⅧⅩ←↑→↓√∧∨≥①②③④⑤⑥⑦⑧⑨⑩⑪⑫⑬⑭⑮ⓥ┃■□▪▲▶►▼◀◆◇○◎●★☆☑☺♡✓✕✱✳✶⠁、。《》「」〔〕一丨口️！＄％＆＇（），－．／：；＝？］｜～￡￥'
sensitive = False
batch_max_length = 99
...
test_root = '/home/xinyudong/data/testforSTR/eval/'
...
root_workdir = '/home/xinyudong/data/workdir/'
